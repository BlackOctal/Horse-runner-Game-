    ...
    return (
      ...
      >
        <div className="bg-black/80 backdrop-blur-sm rounded-lg p-8 text-center space-y-6 max-w-sm mx-4">
          ...
          <p className="text-white text-lg">Please rotate your device to landscape mode to play</p>
          ...
          <div className="w-full max-w-5xl">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="text-white space-y-4 bg-black/60 backdrop-blur-sm rounded-lg p-6">
                <h2 className="text-2xl font-bold text-center md:text-left">Horse Runner</h2>
                <div className="space-y-2 text-base">
                  <p>
                    🖱️ <strong>Desktop:</strong> Press SPACE to jump, ↓ (down arrow) for a fast drop
                  </p>
                  <p>
                    📱 <strong>Mobile:</strong> Tap the screen to jump
                  </p>
                  <p>🌟 Double jump available</p>
                  <p>🧉🥟 Collect items for +100 points</p>
                  <p>🌵 Avoid the cactus</p>
                </div>
              ...
              <div>
                <Card className="bg-amber-100/90 backdrop-blur-sm p-5 h-full">
                  <h3 className="text-xl font-bold mb-3 text-amber-900 text-center">🏆 High Scores</h3>
                  {highScores.length > 0 ? (
                    ...
                    <p className="text-amber-700 text-center">Be the first to play!</p>
                  )}
                </Card>
              </div>
            </div>
      ...
      {gameState === "playing" && (
        <div className="w-full h-screen relative">
          <div className="absolute top-4 left-4 right-20 z-10 flex justify-between items-center text-white text-xl font-bold">
            <span className="bg-black/70 px-4 py-2 rounded-lg">Points: {score.toLocaleString()}</span>
            <span className="hidden md:block bg-black/70 px-4 py-2 rounded-lg text-sm">
              SPACE: Jump | ↓: Fast Drop
            </span>
          </div>
          ...
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white md:hidden">
            <p className="bg-black/70 px-4 py-2 rounded-lg">Tap the screen to jump</p>
          </div>
        </div>
      )}
          ...
          <div className="bg-black/80 backdrop-blur-sm rounded-lg p-8 text-center space-y-6 max-w-md w-full">
            <div className="text-white space-y-4">
              ...
              {highScores.length > 0 && score >= highScores[highScores.length - 1]?.score && (
                <p className="text-green-400 text-xl">🎉 New personal record!</p>
              )}
            </div>
